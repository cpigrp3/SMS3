		...
		<div class="panel panel-default">
           ...
           <div class="col-xs-12">
            <div align="center"><br>
                ...
                <div align = "center" class = "pre-scrollable" style="height: 300px;"> 
                   <table class = "table-hover table-bordered" style = "width: 900px;">
                     <tr class="tblheader">
									...
									$("selItemName").value = y.down("td", 8).innerHTML;
										if ($("selItemName").value == "") {
											swal(
													...
													$("txtQuantity").value = y
															.down("td", 2).innerHTML;
													$("txtReference").value = y
															.down("td", 3).innerHTML;
													$("txtDateAdded").value = y
															.down("td", 4).innerHTML;
													$("txtPurchase").value = y
															.down("td", 5).innerHTML;
												}
